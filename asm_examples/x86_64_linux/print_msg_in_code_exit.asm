...
_start:
	...
	MOV RAX, 60		; syscall number (x86_64 exit is 60)
	MOV RDI, 0		; error_code (max 255)
	SYSCALL
...
; code += b'\x48\x8D\x35\x13\x00\x00\x00'      # LEA RSI,[RIP+0x13] # 24 <msg>  ; calculated by the compiler
